...
void GenerateData() {
	Tutor* newNode1 = AddNode(3, "Onn", "23/5/2022", 10, 40, "0127120665", "KL", "KL", "Math", 2, 400); //create Node
	AddTutorToTheEnd(newNode1);
	Tutor* newNode2 = AddNode(9, "Kelvin", "1/5/2021", 10, 60, "0111111111", "Johor", "Johor", "History", 2.5, 600); //create Node
